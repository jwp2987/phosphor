...
//!
//! Backed by `PersistedWorkspace`'s list of recently used repository roots.
//! Restored from the pin (`02b53fcd8:app/src/terminal/input/repos/data_source.rs`)
//! after `efcaa42b8` gutted it to always return an empty result — that stub
//! existed only because `PersistedWorkspace` had been deleted.
