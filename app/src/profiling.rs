...
/// Dumps the jemalloc heap profile and writes it to the local log.
///
/// This spawns `go tool pprof`, fetching and symbolicating the heap profile from a local HTTP server.
