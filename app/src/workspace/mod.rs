...
pub fn init(app: &mut AppContext) {
    ...
    if ChannelState::enable_debug_features() {
        // Select the local crash-description fluent key based on the platform
    ...
    app.register_editable_bindings([
        EditableBinding::new(
            ...
            crate::t!("keybinding-desc-workspace-new-tab-group"),
        ...
        EditableBinding::new(
            ...
            crate::t!("keybinding-desc-workspace-new-tab-group-from-active-or-selected-tabs"),
        ...
        EditableBinding::new(
            ...
            crate::t!("keybinding-desc-workspace-remove-active-or-selected-tabs-from-group"),
    ...
    app.register_editable_bindings([
        EditableBinding::new(
            ...
            crate::t!("keybinding-desc-workspace-pin-active-tab"),
        ...
        EditableBinding::new(
            ...
            crate::t!("keybinding-desc-workspace-unpin-active-tab"),
        ...
        EditableBinding::new(
            ...
            crate::t!("keybinding-desc-workspace-pin-active-tab-group"),
        ...
        EditableBinding::new(
            ...
            crate::t!("keybinding-desc-workspace-unpin-active-tab-group"),
...
fn add_open_setting_pages_as_editable_binding(app: &mut AppContext) {
    ...
    app.register_editable_bindings([
        ...
        .with_group(bindings::BindingGroup::Settings.as_str())
        .with_context_predicate(id!("Workspace")),
        // Zap Wave 6-8: the `workspace:show_settings_shared_blocks_page`
        // keybinding was physically removed together with the
        // `ShowBlocksView` settings page and `CustomAction::ViewSharedBlocks`.
        EditableBinding::new(
        ...
        .with_group(bindings::BindingGroup::Settings.as_str())
        .with_context_predicate(id!("Workspace")),
        // Zap Wave 6-8: the `workspace:show_settings_referrals_page`
        // keybinding was physically removed together with the
        // `ReferralsPageView` settings page.
        // Zap Wave 7-3: the `workspace:show_settings_environments_page`
        // keybinding was physically removed along with the ambient-agent UI subsystem.
        EditableBinding::new(
...
fn add_overflow_menu_items_as_editable_binding(app: &mut AppContext) {
    ...
    app.register_editable_bindings([
        ...
        EditableBinding::new(
            ...
            crate::t!("keybinding-desc-workspace-send-feedback"),
