...
// Re-export the UI font size constants defined by the underlying warp_core,
...
// Valid range for markdown heading font size multipliers (matches the UI-layer clamp)
...
pub fn heading_font_size_multipliers_from_settings(
    ...
    // Data-layer safeguard: prevents direct TOML edits or cloud sync from injecting 0/negative/oversized values; matches the UI-layer clamp range
