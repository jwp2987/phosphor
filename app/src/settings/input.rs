...
define_settings_group!(InputSettings,
    settings: [
        ...
        // Controls whether the shortcut hints in the Agent view's zero-state are shown:
        // 1) The three zero_state_block lines "ctrl+shift+enter start new conversation / /model switch model / esc back to terminal";
