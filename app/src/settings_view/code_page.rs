...
//! code review.
//!
//! Historically this page also hosted the LSP management subpage plus codebase indexing, but
//! both have been retired; `Code` is no longer an umbrella in the sidebar (there's no second
//! subpage to hang off it), and has become a single-layer Page.
//! What the page renders is exactly this set of toggles.
