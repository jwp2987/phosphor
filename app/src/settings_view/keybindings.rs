...
// migrate to fluent once that file gets its own i18n pass.
...
// Other user-facing strings are resolved at runtime via crate::t!(); see the
// settings-keybindings-* fluent keys.
