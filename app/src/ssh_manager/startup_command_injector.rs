//! Automatically runs a startup command after a successful SSH connection.
//! Once the shell prompt appears, writes startup_command to the PTY + `\n`,
//! then exits after this one-shot injection.
...
/// Spawns the startup command injection task in the owner context.
