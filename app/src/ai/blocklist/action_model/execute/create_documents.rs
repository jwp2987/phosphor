...
impl CreateDocumentsExecutor {
    ...
    pub(super) fn execute(
        ...
        let created_documents: Vec<DocumentContext> = documents
            ...
            .map(|(index, document)| {
                ...
                let artifact = Artifact::Plan {
                    ...
                    notebook_uid: None, // openWarp doesn't sync to the cloud notebook, so always None; opens locally via document_uid
        ...
        // openWarp no longer pushes the plan to Zap Drive; the plan content is
        // already written to the local SQLite ai_document_panes table via
        // AIDocumentModel::enqueue_save, and the user can view and edit it directly
