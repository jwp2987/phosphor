...
impl AskUserQuestionView {
    ...
    fn render_completed(
        ...
        // Collapsed state: just the header -- but still draw the speedbump footer
        // if it's present, since the autonomy nudge must stay visible even if the
        // user collapses their answers.
        if !self.is_expanded {
