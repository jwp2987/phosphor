...
//!   **Ported below**, adapted from `LocalOrRemotePath` to `PathBuf`/`&Path` to match this
//!   fork's (not-yet-migrated) `ai::skills::ParsedSkill::path` type — see issue #205, which
//!   owns that migration for `crates/ai/src/skills` and is out of this file's scope.
//!
