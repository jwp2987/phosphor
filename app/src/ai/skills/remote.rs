//! Daemon-side serialization of the local bundled-skill catalog for the aggregate
//! `RemoteAgentContextSnapshot` push (#353 producer). Consumed client-side by
//! `app::ai::remote_agent_context::bundled_skill_from_protos`, the reverse direction.
//!
//! Ported from the pin's `ai/skills/remote.rs` (`02b53fcd8`).
