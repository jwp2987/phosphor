...
fn write_parameters() -> Value {
    json!({
        ...
        "properties": {
            ...
            "input": {
                "type": "string",
                "description": "Text to write to stdin/PTY. With mode=raw, control-key tokens like <ESC>/<ENTER>/<CTRL-C> may be used."
            },
            "mode": {
                "type": "string",
                "enum": ["raw", "line", "block"],
                "description": "raw = raw bytes; line = as a single line (newline appended automatically); block = as a multi-line block.",
                "default": "line"
            }
        },
...
fn read_parameters() -> Value {
    json!({
        ...
        "properties": {
            ...
            "delay_seconds": {
                "type": "integer",
                "description": "Optional: return the current snapshot after this many seconds; omit to wait until the command completes.",
                "minimum": 0
            }
        },
        "required": ["command_id"],
