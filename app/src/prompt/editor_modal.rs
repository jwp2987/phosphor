...
impl EditorModal {
    pub fn new(ctx: &mut ViewContext<Self>) -> Self {
        ...
        // Context-chip colors are theme-derived and cached here, so rebuild the
        // chips when the theme changes to keep an open editor in sync
        // (preserving the current used-chip selection).
