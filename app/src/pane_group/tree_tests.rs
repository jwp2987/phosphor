...
// `app/src/pane_group/tree_tests.rs`, tracked as issue #334. Backs the
// "double-click a divider to reset that split to equal sizes" convenience;
// `reset_pane_sizes` did not exist in the fork before this port.
#[test]
