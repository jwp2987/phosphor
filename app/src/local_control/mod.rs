...
//!
//! The Settings > Scripting gates used here (`crate::settings::LocalControlSettings`)
//! are local-only, secure-storage-backed settings -- see that module's doc
//! comment for how this fork's implementation differs from the pinned oracle's.
//!
