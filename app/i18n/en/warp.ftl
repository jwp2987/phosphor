...
terminal-shell-premature-subtext = Something went wrong while starting { $shell_detail } and Phosphorizeing it, causing the process to terminate. Phosphorize script output is displayed here, which may point at a cause.
