...
ai-footer-enable-notifications-tooltip = Install the Warp plugin to enable rich agent notifications within Phosphor
...
cli-agent-plugin-codex-plugin-install-title = Install Phosphor Plugin for Codex
cli-agent-plugin-codex-plugin-run-commands-subtitle = Run the following commands, then restart Codex.
cli-agent-plugin-codex-add-marketplace-step = Add the Warp plugin marketplace repository
cli-agent-plugin-codex-plugin-restart-note = Restart Codex to activate the plugin.
cli-agent-plugin-codex-plugin-update-title = Update Phosphor Plugin for Codex
cli-agent-plugin-codex-upgrade-marketplace-step = Upgrade the marketplace
cli-agent-plugin-codex-reinstall-plugin-step = Reinstall the Warp plugin
...
cli-agent-plugin-claude-install-title = Install Phosphor Plugin for Claude Code
...
cli-agent-plugin-claude-update-title = Update Phosphor Plugin for Claude Code
...
cli-agent-plugin-gemini-install-title = Install Phosphor Plugin for Gemini CLI
...
cli-agent-plugin-gemini-update-title = Update Phosphor Plugin for Gemini CLI
...
cli-agent-plugin-opencode-install-title = Install Phosphor Plugin for OpenCode
...
cli-agent-plugin-opencode-update-title = Update Phosphor Plugin for OpenCode
...
agent-tip-oz-headless = Use the `phosphor` command to run a Phosphor agent in headless mode, useful for remote machines.
