...
zap-launch-oad-description = The Phosphor repo is managed by an agent-first local workflow powered by Oz.
...
agent-tip-warpify-ssh = Phosphorize a remote SSH session to enable Oz inside that environment.
