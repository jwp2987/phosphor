...
settings-code-remote-indexed-folders-desc = Repositories on SSH hosts that the remote agent daemon has been asked to index, and what each host reports back. Indexing happens on the host; nothing here is sent to any external server.
