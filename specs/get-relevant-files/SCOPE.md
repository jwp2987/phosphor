# GetRelevantFiles (local BYOP) — scoping + held design decision

**Status: HELD for a maintainer decision** (investigated 2026-08-04, branch
`edition-2024`). Not built autonomously — see "Why held" below.
