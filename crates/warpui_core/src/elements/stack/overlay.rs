...
impl Element for Overlay {
    ...
    fn paint(&mut self, origin: Vector2F, ctx: &mut PaintContext, app: &AppContext) {
        // If already in the overlay layer (created by Stack via start_overlay_layer),
        // paint the child element directly, avoiding nested overlay layers that
        // would cause is_covered to misjudge.
