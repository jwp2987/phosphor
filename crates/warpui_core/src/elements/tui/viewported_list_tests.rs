...
/// Verifies `with_trimmed_selection_line_ends` caps each selected row at its last
/// non-whitespace glyph instead of extending through trailing blank cells to the
/// drag's raw column extent.
///
/// Ported from the pin (`02b53fcd8:crates/warpui_core/src/elements/tui/viewported_list_tests.rs`);
/// issue #436.
#[test]
