...
/// path. Used by consumers that filter individual paths (e.g. the code index)
/// rather than descending a directory tree. Non-existent paths are checked
/// lexically so deletions can still be classified.
