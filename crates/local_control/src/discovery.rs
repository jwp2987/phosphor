//! Private filesystem registry for discovering running local Zap instances.
//!
...
//! trusted Zap code from arbitrary software already running as that user.
...
const DISCOVERY_DIR_ENV: &str = "ZAP_LOCAL_CONTROL_DISCOVERY_DIR";
...
/// Stable identifier for one running Zap instance.
...
/// Filesystem-published routing metadata for a running Zap app process.
///
