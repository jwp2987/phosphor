//! Wire protocol envelopes and error types for Zap local control.
...
/// Parameters for opening a file in Zap's app/editor state.
#[derive(Debug, Clone, PartialEq, Eq, Serialize, Deserialize)]
#[serde(deny_unknown_fields)]
...
/// Top-level request sent by a local-control client to a Zap instance.
#[derive(Debug, Clone, PartialEq, Serialize, Deserialize)]
...
/// Top-level response returned by a Zap instance for a control request.
#[derive(Debug, Clone, PartialEq, Serialize, Deserialize)]
