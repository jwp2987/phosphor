//! Shared protocol, discovery, authentication, and client types for local Zap control.
//!
//! The `local_control` crate is intentionally UI-agnostic so the Zap app and
//! `zapctrl` CLI can share the same wire envelopes, action catalog, discovery
