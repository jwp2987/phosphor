...
// Ported from the pin (crates/editor/src/render/model/mod_tests.rs): the
// `first_hidden_section_line_range` query is a thin wrapper over the already-shipped
// `BlockItem::Hidden` block type; only the tests were missing.
#[test]
