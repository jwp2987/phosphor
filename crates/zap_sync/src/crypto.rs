...
/// Derives a 32-byte key based on the user Token
...
/// Encrypts plaintext using AES-256-GCM, returning a Base64-encoded nonce+ciphertext
///
...
/// Decrypts a Base64-encoded nonce+ciphertext
///
