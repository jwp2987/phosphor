...
/// blue, magenta, Lilac, pink, green, and yellow. The colors are supplied by
/// the caller (`TuiUiBuilder::design_palette`) rather than derived from the
/// ANSI slots, so dark and light each get their own declared values.
