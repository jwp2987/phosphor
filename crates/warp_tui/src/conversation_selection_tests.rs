...
use warp::tui_export::{
    ...
    TerminalModel, AgentViewState, register_tui_session_view_test_singletons,
};
...
/// The full session-view fixture, needed by tests that drive
/// `try_start_new_conversation` (which reaches into singletons the bare
/// fixture above does not register).
