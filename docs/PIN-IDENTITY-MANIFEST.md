...
Generated **2026-08-16**, pin `42effe84055f891405b32914af333f14127ec381`, fork `4f0743334`.

**To regenerate:** `script/generate_pin_identity_manifest`. It needs the pin
commit fetched (`git fetch warp 42effe84055f891405b32914af333f14127ec381`) and writes this file plus the
...
|---|---:|---:|
| **IDENTICAL** — fast-forwardable, zero judgment | 573 | 16% |
| **DIFFERS** — fork touched this file | 2368 | 69% |
| **FORK-ONLY** — no path match at the pin | 464 | 13% |
| **total fork .rs files scanned** | 3405 | 100% |

**Pin-only** (a path the pin has that this scan found no fork counterpart
for): **1021** files. Not itemised here — this is exactly what
...
|---|---:|---:|---:|---:|
| `app/src/ai` | 456 | 36 | 302 | 118 |
| `app/src/terminal` | 428 | 42 | 337 | 49 |
| `crates/warpui_core` | 249 | 66 | 106 | 77 |
| `app/src/search` | 177 | 46 | 112 | 19 |
| `crates/warp_tui` | 177 | 46 | 115 | 16 |
| `crates/warpui` | 159 | 21 | 136 | 2 |
| `crates/ai` | 92 | 30 | 51 | 11 |
| `crates/editor` | 85 | 9 | 72 | 4 |
| `app/src/integration_testing` | 79 | 27 | 51 | 1 |
| `crates/warp_completer` | 68 | 10 | 46 | 12 |
| `app/src/(root files)` | 63 | 10 | 44 | 9 |
| `app/src/workspace` | 59 | 5 | 51 | 3 |
| `crates/warp_core` | 58 | 9 | 34 | 15 |
| `app/src/code` | 56 | 10 | 46 | 0 |
| `app/src/settings` | 55 | 4 | 47 | 4 |
| `app/src/code_review` | 46 | 1 | 37 | 8 |
| `app/src/settings_view` | 46 | 5 | 33 | 8 |
| `crates/integration` | 46 | 3 | 42 | 1 |
| `app/src/drive` | 42 | 2 | 36 | 4 |
| `app/src/util` | 40 | 7 | 25 | 8 |
| `app/src/editor` | 38 | 3 | 25 | 10 |
| `crates/warp_terminal` | 38 | 12 | 24 | 2 |
| `crates/onboarding` | 35 | 1 | 33 | 1 |
| `app/src/pane_group` | 33 | 0 | 29 | 4 |
| `crates/computer_use` | 33 | 20 | 13 | 0 |
| `app/src/notebooks` | 31 | 1 | 29 | 1 |
| `crates/warp_cli` | 28 | 10 | 16 | 2 |
| `app/src/context_chips` | 24 | 2 | 19 | 3 |
| `app/src/remote_server` | 24 | 3 | 15 | 6 |
...
| `crates/warpui_extras` | 18 | 6 | 10 | 2 |
| `app/src/cloud_object` | 15 | 1 | 10 | 4 |
| `app/src/local_control` | 15 | 7 | 8 | 0 |
...
| `crates/markdown_parser` | 7 | 2 | 3 | 2 |
...
`docs/PIN-IDENTITY-MANIFEST-files.tsv` (3405 rows, tab-separated,
header row included).
