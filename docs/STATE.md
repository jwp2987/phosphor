...
Last fully green `script/precheck`: `456a0ca3af94ecaf4db05a5ec452ef2666bfa457` (2026-08-17 10:53) — **20 commit(s) since**
...
Of the absent, **2238 are adjudicated** in the ledger and 584 are not.
...
*projected* at the same ratio (~257 non-cloud), so the figures below
carry that estimate.

The ledger has 2529 rows in total; the 291 beyond the
2238 above adjudicate tests that are **not** absent — the fork already has
...
- **~87.1% of the pin's non-cloud tests exist here** (8406 of ~9650)
- **~95.8% are present or deliberately resolved** (adding 719 declined, 62 divergent, 65 covered-elsewhere)
